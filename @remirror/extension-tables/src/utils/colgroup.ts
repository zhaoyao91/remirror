...
import { getFragmentBackingArray } from './slice';

export const generateColgroup = (node: ProsemirrorNode) => {
...
export const renderColgroupFromNode = (node: ProsemirrorNode) => {
...
export const hasTableBeenResized = (node: ProsemirrorNode) => {
  return !!getFragmentBackingArray(node.content.firstChild!.content).find(cell => cell.attrs.colwidth);
};
